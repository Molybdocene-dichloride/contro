...
\begin{document}
  ...
  \mStyle{При монохлорировании 2-метилпропана (изобутана) при нагревании в качестве основного продукта образуется 2-метил-1-хлорпропан, а в качестве побочного продукта -\\ 2\nobreakdash-метил\nobreakdash-2\nobreakdash-хлорпропан:}
    ...
    \formul{\ce{\chemfig{-[:35.25](-[:90])-[:-35.25]} ->[Cl_2][\parbox{12px}{\fontsize{8pt}{8pt}\selectfont $t°$ -$HCl$}] \chemfig{-[:35.25](-[:90])-[:-35.25](-[:30]Cl)} + \chemfig{-[:20](-[:-70])(-[:90]Cl)-[:-20]}}}
    ...
    \formul{\ce{\chemfig{-[:35.25](-[:90])-[:-35.25]} ->[Cl_2][\parbox{12px}{\fontsize{8pt}{8pt}\selectfont $hv$ -$HCl$}] \chemfig{-[:20](-[:-70])(-[:90]Cl)-[:-20]} + \chemfig{-[:35.25](-[:90])-[:-35.25](-[:30]Cl)}}}
    ...
    \formul{\ce{\chemfig{-[:35.25](-[:90])-[:-35.25]} ->[Cl^{.}][-HCl] \chemfig{-[:35.25]\charge{-90=\.}{}(-[:90])-[:-35.25]}}}
    
    \formul{\ce{\chemfig{-[:35.25](-[:90])-[:-35.25]} ->[Cl^{.}][-HCl] \chemfig{-[:35.25](-[:90])-[:-35.25]\charge{-90=\.}{}}}}

    \formul{\ce{\chemfig{-[:35.25]\charge{-90=\.}{}(-[:90])-[:-35.25]} ->[Cl_2][-Cl^{.}] \chemfig{-[:35.25](-[:90])(-[:30]Cl)-[:-35.25]}}}

    \formul{\ce{\chemfig{-[:35.25](-[:90])-[:-35.25]\charge{-90=\.}{}} ->[Cl_2][-Cl^{.}] \chemfig{-[:35.25](-[:90])-[:-35.25](-[:30]Cl)}}}
    
    \mStyle{– обрыв цепи:}

    \formul{\ce{\chemfig{-[:35.25]\charge{-90=\.}{}(-[:90])-[:-35.25]} ->[Cl^{.}] \chemfig{-[:20](-[:-70])(-[:90]Cl)-[:-20]}}}

    \formul{\ce{\chemfig{-[:35.25](-[:90])-[:-35.25]\charge{-90=\.}{}} ->[Cl^{.}] \chemfig{-[:35.25](-[:90])-[:-35.25](-[:30]Cl)}}}
...
\reaction{Гидробромирование гексадиена-1,3}{
  ...
  \formul{\ce{\chemfig{=[:35.25]-[:-35.25]=[:35.25]-[:-35.25]-[:35.25]} ->[HBr][] \chemfig{=[:35.25]-[:-35.25](-[:-90]Br)-[:35.25]-[:-35.25]-[:35.25]} + \\ + \chemfig{Br-[:-35.25]-[:35.25]=[:-35.25]-[:35.25]-[:-35.25]-[:35.25]} + \chemfig{-[:35.25](-[:90]Br)-[:-35.25]=[:35.25]-[:-35.25]-[:35.25]} + \\ + \chemfig{-[:35.25]=[:-35.25]-[:35.25](-[:90]Br)-[:-35.25]-[:35.25]} + \chemfig{=[:35.25]-[:-35.25]-[:35.25](-[:90]Br)-[:-35.25]-[:35.25]} + \\ + \chemfig{Br-[:-35.25]-[:35.25]-[:-35.25]=[:35.25]-[:-35.25]-[:35.25]}}}
}{\mStyle{Реакция протекает по механизму электрофильного присоединения ($A_E$) и включает следующие стадии:}
 \mStyle{– образование π-комплексов:}
  
  \formul{\ce{\chemfig{=[:35.25]-[:-35.25]=[:35.25]-[:-35.25]-[:35.25]} <-->[HBr] \chemfig{=[:35.25]-[:-35.25]=[:35.25,.5](-[:-35.25,0.7,,,->]H-[:-35.25,0.7,,,]Br)=[:35.25,.5]-[:-35.25]-[:35.25]}}}

  \formul{\ce{\chemfig{=[:35.25]-[:-35.25]=[:35.25]-[:-35.25]-[:35.25]} <-->[HBr] \chemfig{=[:35.25,.5](-[:-35.25,0.7,,,->]H-[:-35.25,0.7,,,]Br)=[:35.25,.5]-[:-35.25]=[:35.25]-[:-35.25]-[:35.25]}}}
  ...
  \formul{\ce{\chemfig{=[:35.25]-[:-35.25]=[:35.25,.5](-[:-35.25,0.7,,,->]H-[:-35.25,0.7,,,]Br)=[:35.25,.5]-[:-35.25]-[:35.25]} ->[][\text{$-Br^⊖$}] \chemfig{=[:35.25]-[:-35.25]\charge{-90=$⊕$}{}-[:35.25]-[:-35.25]-[:35.25]} <-> \\\\ <-> \chemfig{\charge{-90=$⊕$}{}-[:35.25]=[:-35.25]-[:35.25]-[:-35.25]-[:35.25]} \text{≡} \chemfig{\text{\charge{-90:4pt=$\frac{1}{2}⊕$}{}}-[:35.25,,,,,rddbond]-[:-35.25,,,,,rddbond]\text{\charge{-90:4pt=$\frac{1}{2}⊕$}{}}-[:35.25]-[:-35.25]-[:35.25]} \text{≡} \\\\ \text{≡} \chemfig{-[:35.25,,,,,rddbond]\text{\charge{-90:4pt=$⊕$}{}}-[:-35.25,,,,,rddbond]-[:35.25]-[:-35.25]-[:35.25]} }}
%\\\\
  \formul{\ce{\chemfig{=[:35.25,.5](-[:-35.25,0.7,,,->]H-[:-35.25,0.7,,,]Br)=[:35.25,.5]-[:-35.25]=[:35.25]-[:-35.25]-[:35.25]} ->[][\text{$-Br^⊖$}] \chemfig{-[:35.25]\charge{90=$⊕$}{}-[:-35.25]=[:35.25]-[:-35.25]-[:35.25]} <-> \\\\\\ <-> \chemfig{-[:35.25]=[:-35.25]-[:35.25]\charge{90=$⊕$}{}-[:-35.25]-[:35.25]} \text{≡} \chemfig{-[:35.25]\text{\charge{90:4pt=$\frac{1}{2}⊕$}{}}-[:-35.25,,,,,lddbond]-[:35.25,,,,,lddbond]\text{\charge{90:4pt=$\frac{1}{2}⊕$}{}}-[:-35.25]-[:35.25]} \text{≡} \\\\ \text{≡} \chemfig{-[:35.25]-[:-35.25,,,,,lddbond]\charge{90:4pt=$⊕$}{}-[:35.25,,,,,lddbond]-[:-35.25]-[:35.25]} }}
  ...
  \formul{\ce{\chemfig{=[:35.25]-[:-35.25]=[:35.25,.5](-[:-35.25,0.7,,,->]H-[:-35.25,0.7,,,]Br)=[:35.25,.5]-[:-35.25]-[:35.25]} ->[][\text{$-Br^⊖$}] \chemfig{=[:35.25]-[:-35.25]-[:35.25]\charge{90=$⊕$}{}-[:-35.25]-[:35.25]}}}

  \formul{\ce{\chemfig{=[:35.25,.5](-[:-35.25,0.7,,,->]H-[:-35.25,0.7,,,]Br)=[:35.25,.5]-[:-35.25]=[:35.25]-[:-35.25]-[:35.25]} ->[][\text{$-Br^⊖$}] \chemfig{\charge{-90=$⊕$}{}-[:35.25]-[:-35.25]=[:35.25]-[:-35.25]-[:35.25]}}}
  
  \mStyle{– образование продуктов 1,2- и 1,4-присоединения:}
  
  \formul{\ce{\chemfig{=[:35.25]-[:-35.25]\charge{-90=$⊕$}{}-[:35.25]-[:-35.25]-[:35.25]} ->[\text{$Br^⊖$}] \chemfig{=[:35.25]-[:-35.25](-[:-90]Br)-[:35.25]-[:-35.25]-[:35.25]}}}

 \formul{\ce{\chemfig{\charge{-90=$⊕$}{}-[:35.25]=[:-35.25]-[:35.25]-[:-35.25]-[:35.25]} ->[\text{$Br^⊖$}] \chemfig{Br-[:-35.25]-[:35.25]=[:-35.25]-[:35.25]-[:-35.25]-[:35.25]}}}

  \formul{\ce{\chemfig{-[:35.25]\charge{90=$⊕$}{}-[:-35.25]=[:35.25]-[:-35.25]-[:35.25]} ->[\text{$Br^⊖$}] \chemfig{-[:35.25](-[:90]Br)-[:-35.25]=[:35.25]-[:-35.25]-[:35.25]}}}

\formul{\ce{\chemfig{-[:35.25]=[:-35.25]-[:35.25]\charge{90=$⊕$}{}-[:-35.25]-[:35.25]} ->[\text{$Br^⊖$}] \chemfig{-[:35.25]=[:-35.25]-[:35.25](-[:90]Br)-[:-35.25]-[:35.25]}}}
